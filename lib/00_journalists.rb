...
(nombre de handle avec 1 caractère, nombre de handle avec 2 caractères, 
nombre de handle avec 3 caractères, etc)
...
###############################################
#Trie la liste de handle par taille des handle (les plus petits en premiers,
...
#puts "JOURNALISTES PAR MAJUSCULES"
...
compteur = 0
journalistes.each do |item|

    if item.length == 6 #prend en compte le @ mais avec une lettre en plus pour faire 5
    compteur = compteur +1 
        
    end    
end

puts "Il y a #{compteur} Profils contenant 5 caractères"
